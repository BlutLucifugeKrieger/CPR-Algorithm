...
relative_roughness_list_modified_avci_karagoz = []
reynolds_list_modified_avci_karagoz = []
...
class Modified_avci_karagoz:
    ...
    def sobol(self, i, j, x,ii,jj):
        ...
        reynolds_list_modified_avci_karagoz.extend([sub_list[0] for sub_list in reynolds_and_relative_roughness_list if sub_list[0] != 0 and sub_list[0] != 4000])
        relative_roughness_list_modified_avci_karagoz.extend([sub_list[1] for sub_list in reynolds_and_relative_roughness_list if sub_list[1] != 0])
    ...
    def CRP(self):
        x0 = 1/sqrt(fseed)
        for e in relative_roughness_list_modified_avci_karagoz:
            for r in reynolds_list_modified_avci_karagoz:
                iteration = 0
                max_iteration = 7
    ...
    def value_r_e_min_relative_error(self):
        ...
        for e in relative_roughness_list_modified_avci_karagoz:
            for r in reynolds_list_modified_avci_karagoz:
                ...
                if (r != 0):
                    f1 = self.modified_avci_karagoz_equation(r,e)
                    relative_error_modified_avci_karagoz = (abs(f-f1)/f)*100

                    if (relative_error_modified_avci_karagoz == self.min_relative_error_value()):
                        r_min_value_modified_avci_karagoz.append(r)
                        e_min_value_modified_avci_karagoz.append(e)
        ...
        for e in relative_roughness_list_modified_avci_karagoz:
            for r in reynolds_list_modified_avci_karagoz:
                ...
                if (r != 0):
                    ...
                    if (relative_error_modified_avci_karagoz == self.max_relative_error_value()):
                        r_max_value_modified_avci_karagoz.append(r)
                        e_max_value_modified_avci_karagoz.append(e)
